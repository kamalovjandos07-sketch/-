...
st.markdown(
    ...
    <h3 style='text-align: center; color: #00BFFF;'>Кафедра микробиологии, вирусологии</h3>
...
# Логотип (добавь файл logo.png в репозиторий)
...
линическое заключение.</div>", unsafe_allow_html=True)
